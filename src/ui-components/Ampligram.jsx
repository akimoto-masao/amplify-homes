  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imageqos")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconiuw")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vectorlyu")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagegjf")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIconsgb")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="chat-bubble-outline"
            {...getOverrideProps(overrides, "MyIconfur")}
          ></MyIcon>
          <MyIcon
            shrink="0"
            type="send"
            {...getOverrideProps(overrides, "MyIconixd")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconviv")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vectordtl")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
