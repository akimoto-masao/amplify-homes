  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              shrink="0"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconhxj")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Sharepbx")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharerbt")}
            ></Text>
            <MyIcon
              shrink="0"
              type="bookmark_border"
              {...getOverrideProps(overrides, "MyIconnyq")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="share"
              {...getOverrideProps(overrides, "MyIconevt")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconxmr")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read morebfx")}
      >
        <MyIcon
          shrink="0"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIcondfl")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moreulj")}
        ></Text>
      </Flex>
    </Flex>
  );
