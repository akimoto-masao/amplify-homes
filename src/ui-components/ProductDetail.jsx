      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7xhd")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerkqe")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7rrp")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerigr")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7kmr")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28vhk")}
          >
            <Button
              borderRadius="4px"
              display="flex"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonebt")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonsni")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonbmb")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonfcb")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28ohg")}
          >
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonbhm")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonjsx")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonzdl")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonzfh")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
